...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/employee-handbook', title: 'Employee Handbook', icon:'nc-paper', class: '', type: 'user' },
    { path: '/form-w4', title: 'W-4 Form', icon:'nc-paper', class: '', type: 'user' },
    { path: '/form-I9', title: 'I-9 Form', icon:'nc-paper', class: '', type: 'user' },
    { path: '/form-direct-deposit', title: 'Direct Deposit Form', icon:'nc-paper', class: '', type: 'user' },
